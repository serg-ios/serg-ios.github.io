...
21. [Quick Actions](#quick-actions)
...
<img src="../assets/img/my-vocabulary/widget/widget.png" width="300">

### Target

To support widgets, a new target must be created.

<img src="../assets/img/my-vocabulary/widget/new_target.jpg">
...
<img src="../assets/img/my-vocabulary/widget/set_targets.jpg">
...
<img src="../assets/img/my-vocabulary/widget/app_group.jpg">

... remember to add the iCloud capability too in the widget target.

<img src="../assets/img/my-vocabulary/widget/icloud.jpg" width="500">
...
<img src="../assets/img/my-vocabulary/widget/widget_menu_small.jpg" width="300">

... in the next section, I'll talk about creating another widget of other size, in this case, `.systemLarge`.

<img src="../assets/img/my-vocabulary/widget/widget_menu_large.jpg" width="300">
...
<img src="../assets/img/my-vocabulary/widget/both_widgets.jpg" width="300">
